...
80106d03:	8b 00                	mov    (%eax),%eax
  ...
  int k = 0;
  acquire(&(shm_table.lock));
80106d05:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
  uint sz = PGROUNDUP(curproc->sz);
80106d0c:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d11:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d14:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
  acquire(&(shm_table.lock));
80106d1b:	e8 30 d4 ff ff       	call   80104150 <acquire>
80106d20:	b9 f4 54 11 80       	mov    $0x801154f4,%ecx
  int j = 64;
80106d25:	b8 40 00 00 00       	mov    $0x40,%eax
  for (i = 0; i< 64; i++) {
80106d2a:	31 d2                	xor    %edx,%edx
80106d2c:	eb 11                	jmp    80106d3f <shm_open+0x4f>
80106d2e:	66 90                	xchg   %ax,%ax
    if (j == 64 && shm_table.shm_pages[i].id == 0) {
      j = i;
    }
    if (shm_table.shm_pages[i].id == id) {
80106d30:	39 de                	cmp    %ebx,%esi
80106d32:	74 1b                	je     80106d4f <shm_open+0x5f>
  for (i = 0; i< 64; i++) {
80106d34:	83 c2 01             	add    $0x1,%edx
80106d37:	83 c1 0c             	add    $0xc,%ecx
80106d3a:	83 fa 40             	cmp    $0x40,%edx
80106d3d:	74 79                	je     80106db8 <shm_open+0xc8>
    if (j == 64 && shm_table.shm_pages[i].id == 0) {
80106d3f:	83 f8 40             	cmp    $0x40,%eax
80106d42:	8b 19                	mov    (%ecx),%ebx
80106d44:	75 ea                	jne    80106d30 <shm_open+0x40>
80106d46:	85 db                	test   %ebx,%ebx
80106d48:	0f 44 c2             	cmove  %edx,%eax
    if (shm_table.shm_pages[i].id == id) {
80106d4b:	39 de                	cmp    %ebx,%esi
80106d4d:	75 e5                	jne    80106d34 <shm_open+0x44>
      k = 1;
...
80106d5d:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d63:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d6a:	00 
80106d6b:	05 00 00 00 80       	add    $0x80000000,%eax
80106d70:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106d74:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
80106d8d:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106d90:	89 f0                	mov    %esi,%eax
80106d92:	05 00 10 00 00       	add    $0x1000,%eax
80106d97:	89 07                	mov    %eax,(%edi)
  *pointer = (char *)sz;
80106d99:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d9c:	89 30                	mov    %esi,(%eax)
  release(&(shm_table.lock));
80106d9e:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106da5:	e8 96 d4 ff ff       	call   80104240 <release>
  
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106daa:	83 c4 2c             	add    $0x2c,%esp
...
80106db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if (k == 0 && j < 64) {
80106db8:	83 f8 40             	cmp    $0x40,%eax
80106dbb:	74 d0                	je     80106d8d <shm_open+0x9d>
    shm_table.shm_pages[j].id = id;
80106dbd:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106dc0:	c1 e3 02             	shl    $0x2,%ebx
80106dc3:	89 b3 f4 54 11 80    	mov    %esi,-0x7feeab0c(%ebx)
    shm_table.shm_pages[j].frame = kalloc();
...
80106dde:	89 04 24             	mov    %eax,(%esp)
    shm_table.shm_pages[j].frame = kalloc();
80106de1:	89 83 f8 54 11 80    	mov    %eax,-0x7feeab08(%ebx)
    memset(shm_table.shm_pages[j].frame, 0, PGSIZE);
80106de7:	e8 a4 d4 ff ff       	call   80104290 <memset>
    mappages(curproc->pgdir, (char *)sz, PGSIZE, V2P(shm_table.shm_pages[j].frame), PTE_W|PTE_U);
80106dec:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106df3:	00 
80106df4:	e9 64 ff ff ff       	jmp    80106d5d <shm_open+0x6d>
...
80106e16:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
  for (i = 0; i< 64; i++) {
80106e1b:	31 d2                	xor    %edx,%edx
80106e1d:	eb 0c                	jmp    80106e2b <shm_close+0x2b>
80106e1f:	90                   	nop
80106e20:	83 c2 01             	add    $0x1,%edx
80106e23:	83 c0 0c             	add    $0xc,%eax
80106e26:	83 fa 40             	cmp    $0x40,%edx
80106e29:	74 2f                	je     80106e5a <shm_close+0x5a>
    if (shm_table.shm_pages[i].id == id) {
80106e2b:	39 18                	cmp    %ebx,(%eax)
80106e2d:	75 f1                	jne    80106e20 <shm_close+0x20>
      if (shm_table.shm_pages[i].refcnt > 0) {
80106e2f:	8b 48 08             	mov    0x8(%eax),%ecx
80106e32:	85 c9                	test   %ecx,%ecx
80106e34:	7e 06                	jle    80106e3c <shm_close+0x3c>
        shm_table.shm_pages[i].refcnt--;
80106e36:	83 e9 01             	sub    $0x1,%ecx
80106e39:	89 48 08             	mov    %ecx,0x8(%eax)
      }
      if (shm_table.shm_pages[i].refcnt == 0) {
80106e3c:	85 c9                	test   %ecx,%ecx
80106e3e:	75 e0                	jne    80106e20 <shm_close+0x20>
        shm_table.shm_pages[i].id =0;
80106e40:	8d 04 52             	lea    (%edx,%edx,2),%eax
80106e43:	c1 e0 02             	shl    $0x2,%eax
80106e46:	c7 80 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%eax)
80106e4d:	00 00 00 
        shm_table.shm_pages[i].frame =0;
80106e50:	c7 80 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%eax)
80106e57:	00 00 00 
        break;
      }
    }
...
80106e61:	e8 da d3 ff ff       	call   80104240 <release>
  
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106e66:	83 c4 14             	add    $0x14,%esp
80106e69:	31 c0                	xor    %eax,%eax
80106e6b:	5b                   	pop    %ebx
80106e6c:	5d                   	pop    %ebp
80106e6d:	c3                   	ret    
